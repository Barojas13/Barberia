        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Blocks_BarberProfiles_BarberId",
                        column: x => x.BarberId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Schedules_BarberProfiles_BarberId",
                        column: x => x.BarberId,
                        principalTable: "BarberProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BookingAppointments_BarberProfiles_BarberId",
                        column: x => x.BarberId,
                        principalTable: "BarberProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BookingAppointments_BarberServices_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "BarberServices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BookingAppointments_CustomerProfiles_CustomerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Blocks_BarberId_StartUtc_EndUtc",
                table: "Blocks",
                columns: new[] { "BarberId", "StartUtc", "EndUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_BookingAppointments_BarberId_StartUtc_EndUtc",
                table: "BookingAppointments",
                columns: new[] { "BarberId", "StartUtc", "EndUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_BookingAppointments_CustomerId",
                table: "BookingAppointments",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_BookingAppointments_ServiceId",
                table: "BookingAppointments",
                column: "ServiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Schedules_BarberId_DayOfWeek",
                table: "Schedules",
